...
interface EthWithdrawFormProps {
...
export const EthWithdrawForm = ({
  ...
  vaultDecimals,
  setIsMaxWithdraw,
}: EthWithdrawFormProps) => {
  return (
    <div className="space-y-3">
      <div>
        <label className="text-xs text-base-content/60 mb-1 block">Withdraw WETH</label>
        <div className="flex gap-2">
          ...
          <button
            ...
            onClick={() => {
              ...
              setWithdrawAmount(floored.toFixed(4));
        ...
        <div className="flex justify-between text-xs text-base-content/60 mt-1">
          <span>{withdrawAmount || "0"} WETH</span>
          <span>Available: {formatEthAmount(maxWithdraw, assetDecimals)} WETH</span>
        </div>
      </div>
